...
export class WithdrawDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'ເລກບັນຊີຜູ້ຮັບ (Bank Transfer only) — saved to bank_accounts.acc_number',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    example: 'BCEL',
    description: 'ຊື່ທະນາຄານ (Bank Transfer only) — saved to bank_accounts.bank_name',
  })
  @IsOptional()
  @IsString()
  bankName?: string;
